...
<body>
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <img class="ml-0" src=" ./img/train.png" alt="Triple-A Train style="overflow:auto;">
        </div>
      </div>
      <hr class="my-4">
  ...
  <section id="train-details" style="background-color: #181F31;">
    <div class="container pt-5 pb-3">
      <h4 class="text-center text-light">- Detail kereta yang ditemukan -</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="card-body text-right">
                      ...
                      <a href="transactions.php?train=<?= $train['train']; ?>&class=<?= $train['class'] ?>&dept_station=<?= $train['dept_station'] ?>&arr_station=<?= $train['arr_station'] ?>&time-dept-arr=<?= $_GET['time-dept-arr'] ?>&time_dept=<?= $train['dept']; ?>&price=<?= $train['price']; ?>&unique-price=<?= $unique_price; ?>" class="btn btn-outline-orange rounded-pill" style="color: white;">Pilih Paket</a>
                    </div>
                  </div>
                </div>
              </div>
